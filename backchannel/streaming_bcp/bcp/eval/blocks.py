...
#     def __init__(self, win_len=512, hop_len=128):
#         self.win_len = win_len
#         self.hop_len = hop_len

#         self.lpad = win_len // 2
#         self.rpad = win_len - self.lpad
...
#         e.g., 0 => 255
#         """
#         return self.start(idx) + self.win_len - 1
...
#         lookahead_size=16,
#         hop_size=8,
#         stft_kwargs={"win_len": 512, "hop_len": 128},
...
class BlockBound:
    def __init__(
        ...
        lookahead_size=16,
        hop_size=8,
        stft_kwargs={"win_len": 512, "hop_len": 128, "center": True},
        ...
        self._sample_per_after_downsampling = (
            self.stft["win_len"] - self.stft["hop_len"]
        ...
        self._pad_start = int(-1 * stft_kwargs["win_len"] // 2)
...
if __name__ == "__main__":
    b = BlockBound(
        ...
        lookahead_size=0,
        hop_size=4,
        stft_kwargs={"win_len": 320, "hop_len": 160, "center": True},
        conv_kwargs={"kernel": [3, 3], "stride": [2, 2], "name": "conv2d"},
    )
