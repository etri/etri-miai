...
class BCTrainer(Trainer):
    ...
    def run(
        ...
        for iepoch in range(start_epoch, trainer_options.max_epoch + 1):
            ...
            # Comment by yschoi on 231103: Adding an "epoch" for contrastive learning
    ...
    def train_one_epoch(
        ...
        for iiter, (utt_id, batch) in enumerate(
            ...
            batch["utt_id"] = utt_id
            # commented by yschoi on 231103: Inserting the current epoch and max epoch into the batch
            batch["current_epoch"] = epoch
            batch["max_epoch"] = max_epoch
            batch["seed"] = seed
            batch["iiter"] = iiter
