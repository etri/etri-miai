...
if [ -f $srcdir/bc_text ]; then
  cp $srcdir/bc_text $destdir/
fi
if [ -f $srcdir/bc2spk ]; then
  cp $srcdir/bc2spk $destdir/
fi
if [ -f $srcdir/spk2bc ]; then
  cp $srcdir/spk2bc $destdir/
fi
if [ -f $srcdir/bc_label ]; then
  cp $srcdir/bc_label $destdir/
fi
