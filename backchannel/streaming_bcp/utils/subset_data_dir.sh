...
if [[ $spk_list ]]; then
  ...
  # utils/filter_scp.pl "$spk_list" $srcdir/spk2bc > $destdir/spk2bc || exit 1;
  # utils/spk2utt_to_utt2spk.pl < $destdir/spk2bc > $destdir/bc2spk || exit 1;
elif [[ $utt_list ]]; then
...
[ -f $srcdir/bc_text ] &&
  utils/filter_scp.pl $destdir/bc2spk <$srcdir/bc_text >$destdir/bc_text
